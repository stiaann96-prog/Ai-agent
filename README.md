    ...
    <script type="text/babel">
        ...
        function NasdaqMethodologyAIAgent() {
            ...
            useEffect(() => {
                ...
                setMessages([{
                    role: 'assistant',
                    content: `# Welcome to Nasdaq Methodology AI Agent 🚀
...
## Example Questions:
• "What are the eligibility criteria for NDX?"
• "How does the Nasdaq-100 cap weights?"
• "What liquidity filters does the Nasdaq Biotechnology Index use?"
...
Provide a comprehensive, accurate answer based on your methodology knowledge. Be specific about details like percentages, thresholds, and timelines. Use clear formatting with headers and bullet points.`;
            ...
            const quickQuestions = [
                { q: "What are NDX eligibility criteria?", icon: "📋" },
                { q: "How does NDX rebalancing work?", icon: "🔄" },
                { q: "Compare NDX vs COMP methodologies", icon: "⚖️" }
            ];
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-blue-200 mt-1">🧪 Debug Version • Claude AI • 422 Documents</p>
                                    </div>
                                </div>
                            ...
                            <div className="border-t-2 border-blue-200 bg-gradient-to-r from-gray-50 to-blue-50 p-6">
                                ...
                                <div className="text-center mt-4">
                                    <p className="text-xs text-gray-600">
                                        🧪 Debug Version • Check browser console (F12) for detailed logs
                                    </p>
                                    <p className="text-xs text-blue-600 mt-1">
                                        💡 For full functionality, deploy to Netlify or Vercel
                                    </p>
                                </div>
                            </div>
                        </div>
